...
import static org.apache.kafka.common.config.ConfigDef.ValidName.validName;
...
public class ConnectorConfig extends AbstractConfig {
    ...
    public static ConfigDef configDef() {
        return new ConfigDef()
                .define(NAME_CONFIG, Type.STRING, ConfigDef.NO_DEFAULT_VALUE, validName(), Importance.HIGH, NAME_DOC, COMMON_GROUP, 1, Width.MEDIUM, NAME_DISPLAY)
